...
name: cog
description: >
  Bootstrap or reconfigure Cog memory domains. Creates directory structure,
  domain config, and starter files. Run /cog for first-time setup or to
  add new domains.
---

# Cog Setup

Bootstrap your memory system through conversation. Discover the user's domains, then generate `memory/domains.yml` and all directory structure.
